...
start /B /wait C:/"Program Files"/SEGGER/%compilerVersion%/bin/emBuild.exe -config "Release" ../../BTLDR/ses/beep_bootloader.emProject
if %ERRORLEVEL% NEQ 0 (
...
start /B /wait ../nrfutil.exe settings generate --family NRF52840 --application PRJ/ses/Output/Release/Exe/BeepBase.hex --application-version 1 --bootloader-version 1 --bl-settings-version 1 BTLDR/ses/Output/Release/Exe/BL_settings.hex
if %ERRORLEVEL% NEQ 0 (
...
start /B /wait ../mergehex.exe --merge BTLDR/ses/Output/Release/Exe/BL_settings.hex BTLDR/ses/Output/Release/Exe/beep_bootloader.hex --output BTLDR/ses/Output/Release/Exe/BTLDR_settings.hex
if %ERRORLEVEL% NEQ 0 (
...
start /B /wait ../mergehex.exe --merge PRJ/ses/Output/Release/Exe/BeepBase.hex nRF5_SDK_15.3/components/softdevice/s140/hex/s140_nrf52_6.1.1_softdevice.hex --output BTLDR/ses/Output/Release/Exe/APP_SD.hex
if %ERRORLEVEL% NEQ 0 (
...
start /B /wait ../mergehex.exe --merge BTLDR/ses/Output/Release/Exe/beep_bootloader.hex BTLDR/ses/Output/Release/Exe/APP_SD.hex --output BTLDR/ses/Output/Release/Exe/APP_SD_BL.hex
if %ERRORLEVEL% NEQ 0 (
...
start /B /wait ../mergehex.exe --merge BTLDR/ses/Output/Release/Exe/BL_settings.hex BTLDR/ses/Output/Release/Exe/APP_SD_BL.hex --output BTLDR/ses/Output/Release/Exe/Beepbase.hex
if %ERRORLEVEL% NEQ 0 (
...
start /B /wait ../nrfutil.exe pkg generate --hw-version 52 --application-version 1 --application PRJ/ses/Output/Release/Exe/BeepBase.hex --sd-req 0xB6 --key-file Key/private.key BTLDR/ses/Output/Release/Exe/Beepbase_app.zip 
if %ERRORLEVEL% NEQ 0 (
